		...
		<div class="container">
			<div class="row">
				<div class="col-md-12">
					...
					<p><em><?php echo $classDescription; ?></em></p>
					<p><b>Student Access ID: <?php echo $classID; ?></b></p>
					<hr></div>
					<div class="row">
						<div class="col-md-6">
							<h5>Quizzes</h5>
							<table class="table">
								...
								$query = "SELECT QuizID, Name, ActiveDate, DeadlineDate FROM quizzes WHERE quizzes.ClassID = $course";
						...
						<div class="col-md-6">
							...
							<table class="table">
								...
								$query = "SELECT FirstName, LastName, PhoneNumber, Email 
									...
									WHERE ClassID = $course and IsTeacher = 0";
